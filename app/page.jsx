...
export default function Home() {
  ...
  return (
    <main className='bg-[#100E1D] max-w-[1440px] lg:flex'>
      <section
        id='search'
        className='bg-[#1E213A] min-w-[475px] max-h-screen max-w-[1440px]'
      >
        ...
        {isOpen && (
          <div className='fixed left-0 top-0 bg-[#1E213A] h-full border-r border-r-gray-900 pb-5 mb-5 ease-in-out duration-500 sm:w-[100%] md:w-[20%] lg:w-[35%]'>
            <div
            ...
            <div className='flex justify-between items-center text-white mx-10 mr-10'>
            ...
            <div
              ...
              className='p-10 m-10 text-white flex justify-between items-center hover:border border-solid border-[#616475]'
            >
              <span>London</span>
              <span>{`>`}</span>
            </div>
      ...
      <section
        id='components'
        className='bg-[#100E1D] text-white max-h-screen max-w-[1440px]'
      >
        <div id='units' className='flex justify-end items-center px-4'>
          <CustomButton
            title='°C'
        ...
        <div
          id='forecast'
          className='bg-[#100E1D] grid grid-cols-2 md:grid-cols-6 gap-3'
        >
          <Forecast
            index={1}
            min={dailyMin}
        ...
        <div id='details' className='bg-[#100E1D]'>
          <div className='mx-6 px-5 py-6'>
            <h1 className='text-[#E7E7EB] text-2xl'>Today's Highlights</h1>
          </div>
          <div className='bg-[#100E1D] text-white mx-6 px-5 py-6 flex flex-wrap gap-3'>
            <Wind
              windSpeed={windSpeed}
              units={units}
